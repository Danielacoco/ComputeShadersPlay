...
/* Note: I modified Fournier Antoine's Xparticle file in order to work in VR and use 
 * it as an example to genereate my own visualizations.
 I also used his simple shader to colour the particles depending on their velocity*/
public class FreeParticle : MonoBehaviour
{
	...
	void Update()
	{
		...
		float[] controlPosition = {pos.x, pos.y, pos.z};

		// Send datas to the compute shader
		computeShader.SetFloat("deltaTime", Time.deltaTime);
		computeShader.SetFloats("controlPosition", controlPosition);
